...
function push(parent, value) {
  ...
  const thennablePushRef = child(parent, name3);
...
function initStandalone({ app, url, version: version3, customAuthImpl, customAppCheckImpl, namespace, nodeAdmin = false }) {
  ...
  return {
    instance: new Database2(repoManagerDatabaseFromApp(app, authProvider, appCheckProvider, url, nodeAdmin), app),
    namespace
  };
}
...
@firebase/database-compat/dist/index.esm2017.js:
   ...
   *)
*/
//# sourceMappingURL=firebase_compat_database.js.map
